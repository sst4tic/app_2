...
// import 'filter_sliverlist.dart';
//
// class BuildCatalogItem extends StatefulWidget {
//   const BuildCatalogItem({Key? key, required this.product}) : super(key: key);
//   final List<Product> product;
//
//   @override
//   State<BuildCatalogItem> createState() => _BuildCatalogItemState();
// }
//
...
//           delegate: SliverChildBuilderDelegate(childCount: widget.product.length,
//               (BuildContext context, int index) {
//             final media = widget.product[index].media?.map((e) => e.toJson()).toList();
...
//                   child: Center(
//                       child: widget.product.length >= 6 && hasMore
